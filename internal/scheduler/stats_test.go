...
func TestSchedulerStats(t *testing.T) {
	s := New(testCfg(), newMemLoader(nil), rule.New(rule.Config{}, &fakeRuleStore{}, nil, nil, nil), nil, nil, nil, nil)
	...
	s2 := New(testCfg(), m, rule.New(rule.Config{}, &fakeRuleStore{rules: map[int64]domain.Rule{}, next: 1}, nil, nil, nil), nil, nil, nil, nil)
