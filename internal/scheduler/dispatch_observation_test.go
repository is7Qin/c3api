...
func TestDispatchObservation_requiresCompleteMetadata(t *testing.T) {
	plan := NewAttemptPlan(AttemptPlanIdentity{RequestID: "req-abc", UserID: 99, RouteClassID: "rc-hex-64-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", RoutingGeneration: 7}, RouteDecision{Primary: []int64{1}})
